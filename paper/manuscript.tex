...
We introduced Wikibooks-ML, an open six-language benchmark for curriculum--content matching, and studied contrastive learning on it through the lens of curriculum structure. Fine-tuning a multilingual sentence transformer with InfoNCE achieves an F2 of 0.670 on a strict holdout, and our curriculum-aware H-InfoNCE variant accelerates convergence. The analysis surfaces a threshold-induced bias in the standard F2 metric and quantifies how fine-tuning reshapes cross-lingual embedding geometry. The released dataset and code provide a reproducible foundation for equitable educational recommendation research.
...
\dataavailability{The Wikibooks-ML dataset and code are available at \url{[repository URL to be added upon acceptance]}. The raw data are derived from Wikibooks XML dumps available at \url{https://dumps.wikimedia.org/}.}
