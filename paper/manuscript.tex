...
\bottomrule
\end{tabularx}
\noindent{\footnotesize{$^{*}$ Trained with reduced learning rate ($1\times10^{-4}$), extended warmup (3 epochs), and lower final learning rate ($1\times10^{-5}$) to avoid the training instability observed at higher learning rates.}}
\end{table}
